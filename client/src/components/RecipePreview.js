...
//this function sets the string value based on the category id integer
 ...
 const onClick = () => {
  ...
  return (
    ...
    <div onClick={onClick} className=" cursor-pointer m-8 pl-10 pr-10 pt-5 pb-5 hover:scale-105 hover:bg-[#D15E51] transition ease-in-out bg-sunset rounded-[20px] w-60 outline h-90 outline-offset-2outline-charcoal shadow-[8px_8px_#AE574D]">
