...
//this function sets the string value based on the category id integer
 ...
 const onClick = () => {
  ...
  return (
    ...
    <div onClick={onClick} className="m-8 p-5 hover:scale-105 hover:bg-[#D15E51] transition ease-in-out bg-sunset rounded-[20px] w-60 outline outline-offset-2outline-charcoal shadow-[8px_8px_#AE574D]">
